...
<Frame>
  <img src="/images/Architecture.png" alt="a1facts Architecture Diagram" />
</Frame>
...
<Steps>
    <Step title="Define Your Domain">
        ...
        <Frame>
            <img src="/images/Onto_example.png" alt="Example of an ontology definition in YAML" />
        </Frame>
    </Step>
    <Step title="Populate the Graph">
        ...
        <Frame>
            <img src="/images/example_KG.png" alt="Visualization of a knowledge graph with entities and relationships" />
        </Frame>
    </Step>
    <Step title="Query with Confidence">
        ...
        <Frame>
            <img src="/images/Query_example.jpeg" alt="Example of a natural language query and the corresponding graph traversal" />
        </Frame>
    </Step>
</Steps>
